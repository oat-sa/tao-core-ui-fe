...
var _defaults = {
    ...
    pollSingleIntervals: [{ iteration: 4, interval: 1000 }],
    pollAllIntervals: [
...
export default function taskQueueModel(config) {
    ...
    model = eventifier({
        ...
        getAll: function getAll() {
            ...
            status = request(config.url.all, { limit: 100 }, 'GET', {}, true).then(function(taskData) {
                var newCache = {};
                //check taskData
                if (taskData) {
                    if (_cache) {
        ...
        pollAll: function pollAll(immediate) {
            ...
            var _updateInterval = function _updateInterval(pollingInstance) {
                ...
                if (loop) {
                    ...
                    if (
                        pollingInterval &&
                        typeof pollingInterval.iteration !== 'undefined' &&
