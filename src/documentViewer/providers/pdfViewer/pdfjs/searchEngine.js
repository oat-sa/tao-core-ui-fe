...
import matchTpl from 'ui/documentViewer/providers/pdfViewer/pdfjs/match';
...
function pdfjsSearchFactory(config) {
    ...
    if (!_.isPlainObject(textManager)) {
        throw new TypeError(
            'You must provide a textManager to give access to the PDF text content! [config.textManager is missing]'
        );
    }
