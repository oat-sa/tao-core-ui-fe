...
import formTpl from 'ui/dateRange/tpl/select';
import 'ui/dateRange/css/dateRange.css';
...
function dateRangeFactory(container, config) {
    ...
    var useTemplate =
        preConfig.startPicker &&
        !preConfig.startPicker.replaceField &&
        preConfig.endPicker &&
        !preConfig.endPicker.replaceField;
    /**
                            ...
                            if (value && self.endPicker && self.endPicker.is('ready')) {
                                ...
                                if (self.config.maxRangeDays > 0) {
                                    self.endPicker.updateConstraints(
                                        'maxDate',
                                        moment(value)
                                            .add(self.config.maxRangeDays, 'd')
                                            .toDate()
                                    );
                                }
                            }
