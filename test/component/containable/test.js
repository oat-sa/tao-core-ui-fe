 ...
 */
define(['jquery', 'ui/component', 'ui/component/placeable', 'ui/component/containable'], function(
    $,
    componentFactory,
    makePlaceable,
    makeContainable
    ...
    QUnit.cases.init([{ title: 'containIn' }]).test('component API', function(data, assert) {
    ...
    QUnit.cases
        .init([
            ...
            {
                title: 'overflow right, paddingRight',
                moveToX: 291,
                moveToY: 100,
                expectedX: 290,
                expectedY: 100,
            ...
            {
                title: 'overflow left, paddingLeft',
                moveToX: 9,
                moveToY: 100,
                expectedX: 10,
                expectedY: 100,
            ...
            {
                title: 'overflow bottom, paddingBottom',
                moveToX: 100,
                moveToY: 391,
                expectedX: 100,
                expectedY: 390,
    ...
    QUnit.cases
        .init([
            ...
            {
                title: 'edge bottom, paddingBottom',
                moveToX: 100,
                moveToY: 390,
                expectedX: 100,
                expectedY: 390,
        ...
        component
            .on('render', function() {
                ...
                $container.find('input').on('change', function(e) {
                    e.preventDefault();
                    self.containIn($container, { padding: $padding.val() }).moveTo($xPos.val(), $yPos.val());
                });
