...
define([
    ...
    QUnit.cases
        .init([{ title: 'resizeTo', method: 'resizeTo' }, { title: '_getCappedValue', method: '_getCappedValue' }])
    ...
    QUnit.cases
        ...
        .test('.resizeTo()', function(data, assert) {
            ...
            component
                .on('beforeresize', function(width, height, fromLeft, fromTop) {
                    ...
                    assert.equal(
                        fromLeft,
                        data.fromLeft,
                        'correct value for resizeFromLeft has been passed as an event parameter'
                    );
                    assert.equal(
                        fromTop,
                        data.fromTop,
                        'correct value for resizeFromTop has been passed as an event parameter'
                    );
                })
            ...
            component.resizeTo(data.resizeW, data.resizeH, data.fromLeft, data.fromTop);
