...
define(['jquery', 'lodash', 'ui/actionbar'], function($, _, actionbar) {
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.notStrictEqual(
            actionbar(),
            actionbar(),
            'The actionbar factory provides a different object on each call'
        );
    });
    ...
    QUnit.test('render ', function(assert) {
        ...
        assert.equal(
            ...
            'object',
            'The actionbar instance returns the rendered content as an object'
        );
        ...
        assert.equal(
            instance.getElement().hasClass('horizontal-action-bar'),
            true,
            'The actionbar instance is rendered horizontally'
        );

        assert.equal(
            instance.getElement().find('button').length,
        ...
        assert.equal(
            instance.getElement().hasClass('vertical-action-bar'),
            true,
            'The actionbar instance is rendered vertically'
        );
        instance.destroy();
    ...
    QUnit.test('show/hide', function(assert) {
        ...
        assert.equal(
            ...
            false,
            'The actionbar instance does not have the hidden class'
        );
    ...
    QUnit.test('show/hide buttons', function(assert) {
        ...
        assert.equal(
            $component.find('button.conditional').hasClass('hidden'),
            true,
            'The conditional buttons are hidden by default'
        );
        assert.equal(
            $component.find('button:not(.conditional)').hasClass('hidden'),
            false,
            'The normal buttons are visible by default'
        );
    ...
    QUnit.test('enable/disable', function(assert) {
        ...
        assert.equal(
            ...
            false,
            'The actionbar instance does not have the disabled class'
        );
    ...
    QUnit.test('state', function(assert) {
        ...
        assert.equal(
            ...
            false,
            'The actionbar instance does not have the customState class'
        );
        ...
        assert.equal(
            instance.getElement().hasClass('customState'),
            true,
            'The actionbar instance has the customState class'
        );
            ...
            buttons: [
                {
                    ...
                    action: function(buttonId) {
                        ...
                        assert.equal(
                            buttonId,
                            'button1',
                            'The actionbar instance provides the button identifier when a button is clicked'
                        );
                        ready();
                    }
                }
