 ...
 */
define(['jquery', 'lodash', 'ui/taskQueue/table', 'css!taoCss/tao-main-style.css', 'css!taoCss/tao-3.css'], function(
    $,
    _,
    ...
    QUnit.test('create table', function(assert) {
        ...
        taskTable
            ...
            .on('loaded', function() {
                ...
                assert.equal(
                    $('.datatable-container > table tbody tr', $component).length,
                    3,
                ...
                assert.equal(
                    ...
                    2,
                    'Each row contains 2 buttons'
                );
                ready();
            })
            .init({
                dataUrl: '/test/taskQueue/table/data.json',
                statusUrl: '/test/taskQueue/table/data-status.json',
                removeUrl: '/test/taskQueue/table/data-archived.json'
            })
    ...
    QUnit.test('create table with download button', function(assert) {
        ...
        taskTable
            ...
            .init({
                ...
                statusUrl: '/test/taskQueue/table/data-status.json',
                removeUrl: '/test/taskQueue/table/data-archived.json',
                downloadUrl: '/test/taskQueue/table/data-archived.json'
            })
            .render($fixtureContainer);
    });
});
