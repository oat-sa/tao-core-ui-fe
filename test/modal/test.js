...
define(['jquery', 'lodash', 'ui/modal', 'tpl!test/ui/modal/modal'], function ($, _, modalListener, modalTpl) {
    ...
    QUnit.test('innerScroll', function (assert) {
        ...
        const $container = $('#modal-1');
        const $modal = $(modalTpl());
        const $scrolledContainer = $('<div style="height: 200px; overflow: auto;"></div>');
        const $content = $('<div style="height: 1000px;">Body</div>');
