define(['jquery', 'ui/progressbar'], function ($) {
    ...
    QUnit.test('Destroy', function (assert) {
        ...
        $elt.progressbar().progressbar('destroy');
    });
    ...
    QUnit.test('update', function (assert) {
        ...
        $elt.progressbar().progressbar('update', 55);
    });
    ...
    QUnit.test('set value', function (assert) {
        ...
        $elt.progressbar().progressbar('value', 42);
    });
    ...
    QUnit.test('get value', function (assert) {
        ...
        $elt.progressbar().progressbar('value', 66);
    });
    ...
    QUnit.test('show progress', function (assert) {
        ...
        $elt.progressbar({ showProgress: true }).progressbar('update', 38);
    });
});
