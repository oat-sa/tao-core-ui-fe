 ...
 */
define(['jquery', 'ui/destination/selector', 'json!test/ui/destination/selector/classes.json'], function(
    $,
    ...
    QUnit.test('Rendering', function(assert) {
        ...
        destinationSelectorFactory($container, {
            ...
            .on('render', function() {
                ...
                assert.equal(
                    $('.destination-selector', $container)[0],
                    $element[0],
                ...
                this.on('update', function() {
                    ...
                    setTimeout(function() {
                        ...
                        self.on('select', function(uri) {
                            assert.equal(
                                uri,
                                'http://bertaodev/tao.rdf#i1516810104355796',
                                'The selected URI is correct'
                            );
