...
define(['jquery', 'lodash', 'ui/mediaplayer'], function($, _, mediaplayer) {
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.equal(
            typeof mediaplayer.youtubePolling,
            'number',
            'The mediaplayer factory exposes a config entry to set the YouTube polling delay'
        );
    ...
    QUnit.cases.init(mediaplayerApi).test('API ', function(data, assert) {
    ...
    QUnit.test('DOM [audio player]', function(assert) {
        ...
        var url = '/test/mediaplayer/samples/audio.mp3';
        ...
        instance
            .on('render', function($dom) {
                ...
                assert.equal(
                    ...
                    1,
                    'The media player has been inserted into the page'
                );
    ...
    QUnit.test('DOM [video player]', function(assert) {
        var ready = assert.async();
        var url = '/test/mediaplayer/samples/video.mp4';
    ...
    var mediaplayerTypes = [
        {
            ...
            url: [
                {
                    src: '/test/mediaplayer/samples/audio.mp3',
                    type: 'audio/mp3'
                },
                {
                    src: '/test/mediaplayer/samples/audio.m4a',
                    type: 'audio/m4a'
                },
                {
                    src: '/test/mediaplayer/samples/audio.ogg',
                    type: 'audio/ogg'
                }
            ]
        },
        {
            ...
            url: [
                {
                    src: '/test/mediaplayer/samples/video.mp4',
                    type: 'video/mp4'
                },
                {
                    src: '/test/mediaplayer/samples/video.ogm',
                    type: 'video/ogm'
                },
                {
                    src: '/test/mediaplayer/samples/video.webm',
                    type: 'video/webm'
                }
            ]
        },
    ...
    if (skipPlaybackIfUnsupported && !mediaplayer.canPlay()) {
        ...
        QUnit.cases.init(mediaplayerTypes).test('Events ', function(data, assert) {
        ...
        QUnit.cases.init(mediaplayerTypes).test('Option autoStart ', function(data, assert) {
            var ready = assert.async();
            if (!mediaplayer.canPlay(data.type)) {
                throw new Error('The browser does not support the ' + data.type + ' player!');
            }
        ...
        QUnit.cases.init(mediaplayerTypes).test('Option autoStartAt ', function(data, assert) {
            var ready = assert.async();
            if (!mediaplayer.canPlay(data.type)) {
                throw new Error('The browser does not support the ' + data.type + ' player!');
            }
        ...
        QUnit.cases.init(mediaplayerTypes).test('Option canPause ', function(data, assert) {
            var ready = assert.async();
            if (!mediaplayer.canPlay(data.type)) {
                throw new Error('The browser does not support the ' + data.type + ' player!');
            }
        ...
        QUnit.cases.init(mediaplayerTypes).test('Option startMuted ', function(data, assert) {
        ...
        QUnit.cases.init(mediaplayerTypes).test('Option volume ', function(data, assert) {
            var ready = assert.async();
            if (!mediaplayer.canPlay(data.type)) {
                throw new Error('The browser does not support the ' + data.type + ' player!');
            }
        ...
        QUnit.cases.init(mediaplayerTypes).test('Option loop ', function(data, assert) {
            var ready = assert.async();
            if (!mediaplayer.canPlay(data.type)) {
                throw new Error('The browser does not support the ' + data.type + ' player!');
            }
        ...
        QUnit.cases.init(mediaplayerTypes).test('Option maxPlays ', function(data, assert) {
            var ready = assert.async();
            if (!mediaplayer.canPlay(data.type)) {
                throw new Error('The browser does not support the ' + data.type + ' player!');
            }
            ...
            mediaplayer({
                ...
                .on('limitreached', function() {
                    ...
                    if (this.is('playing') || count > expected) {
                        ...
                        assert.ok(
                            true,
                            'The media player has stopped the playback after the play limit has been reached'
                        );
                    }
    ...
    QUnit.cases.init(mediaplayerTypes).test('Option renderTo ', function(data, assert) {
    ...
    QUnit.cases.init(mediaplayerTypes).test('Show/Hide ', function(data, assert) {
        var selector = '#fixture-' + data.fixture;
        var ready = assert.async();
        mediaplayer({
            url: data.url,
    ...
    QUnit.cases.init(mediaplayerTypes).test('Enable/Disable ', function(data, assert) {
        var ready = assert.async();
        var selector = '#fixture-' + data.fixture;
        mediaplayer({
            url: data.url,
    ...
    QUnit.cases.init(mediaplayerTypes).test('Sources management ', function(data, assert) {
