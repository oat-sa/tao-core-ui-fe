...
define(['jquery', 'lodash', 'ui/pagination', 'css!taoCss/tao-main-style.css'], function($, _, paginationComponent) {
    'use strict';
    ...
    QUnit.test('Critical conditions', function(assert) {
        ...
        pagination
            ...
            .on('change', function() {
                ...
                assert.ok(
                    pagination.getActivePage() <= 7 && pagination.getActivePage() >= 1,
    ...
    QUnit.test('render', function(assert) {
        ...
        paginationComponent({ mode: 'pages' })
            .on('render', function() {
                assert.equal($('.icon-backward', $container).length, 1, 'The backward button exists');
    ...
    QUnit.test('simple simple', function(assert) {
        ...
        pagination2
            .on('render', function() {
                ...
                assert.equal(
                    typeof pagination1.getActivePage(),
                    'undefined',
                    'p2 Pagination 1 have not been initialized'
                );
