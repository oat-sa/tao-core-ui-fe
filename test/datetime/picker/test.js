        ...
        dateTimePicker(container, {
            ...
            .on('ready', function() {
                ...
                assert.equal(
                    field.placeholder,
                    'Enter lunch time',
                    'The input field placeholder has the configured value'
                );
                ...
                assert.equal(
                    ...
                    'Usual lunch time',
                    'The input field label has the configured value'
                );
    ...
    QUnit.test('Input field with controls', function(assert) {
        ...
        dateTimePicker(container, {
            ...
            .on('init', function() {
                assert.equal(container.querySelectorAll('input').length, 0, 'No input field found');
                assert.equal(
                    container.querySelectorAll('.picker-toggle').length,
                    0,
                    'The toggle button is not attached'
                );
    ...
    QUnit.test('Replace Input field', function(assert) {
        ...
        dateTimePicker(container, {
            ...
            assert.equal(
                field.placeholder,
                "Enter today's date",
                'The placeholder has been taken from the original field'
            );
    ...
    QUnit.test('Update constraints', function(assert) {
        ...
        dateTimePicker(container, {
            ...
            .on('open', function() {
                ...
                assert.equal(
                    picker.querySelectorAll('.flatpickr-day:not(.disabled)').length,
                    2,
                    'Ony 3 dates can be seleted'
                );
