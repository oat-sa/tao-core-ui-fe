...
define([
    ...
    QUnit.test('stepNavigation', function (assert) {
        ...
        assert.equal(
            typeof stepNavigationPluginFactory(calculator),
            'object',
            'The plugin factory produces an instance'
        );
        assert.notStrictEqual(
            stepNavigationPluginFactory(calculator),
            stepNavigationPluginFactory(calculator),
    ...
    QUnit.test('install', function (assert) {
        ...
        var calculator = calculatorBoardFactory($container)
            .on('ready', function () {
                ...
                assert.ok(
                    !calculator.hasCommand('stepDeleteRight'),
                ...
                plugin
                    ...
                    .then(function () {
                        ...
                        assert.ok(
                            ...
                            'The command stepMoveRight is now registered'
                        );
                        assert.ok(
                            calculator.hasCommand('stepDeleteLeft'),
                            'The command stepDeleteLeft is now registered'
                        );
                        assert.ok(
                            calculator.hasCommand('stepDeleteRight'),
                    ...
                    .then(function () {
                        return new Promise(function (resolve) {
                            ...
                            assert.equal(
                                ...
                                expression.length,
                                'The position is at the end of the expression'
                            );
                            assert.equal(
                                calculator.getTokenIndex(),
                                tokens.length - 1,
                                'Current token is the last one'
                            );
                            ...
                            calculator
                                .after('command-stepMoveLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        expression.length - 1,
                                        'The position has been moved a term back'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        tokens.length - 1,
                                        'The current token is still the same'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        expression.length - 6,
                                        'The position has been again moved a term back'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        tokens.length - 2,
                                        'The current token should now have changed'
                                    );
                                    ...
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        1,
                                        'The current token has been set to index 1'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        1,
                                        'The position should have been moved 1 step back'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        0,
                                        'The current token should have moved 1 step back'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        0,
                                        'The position should be now at the beginning'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        0,
                                        'The current token should be the first'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        0,
                                        'The current token should not have changed'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        2,
                                        'The position should be moved 1 step forward'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        1,
                                        'The current token should be moved 1 step forward'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        3,
                                        'The position should be moved again 1 step forward'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        2,
                                        'The current token should be moved again 1 step forward'
                                    );
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        expression.length - 4,
                                        'The position has been set to the middle of the N-1 term'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        tokens.length - 2,
                                        'The current token has been set to index N-1'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        expression.length - 1,
                                        'The position should have been set the last term'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        tokens.length - 1,
                                        'The current token should be the last one'
                                    );
                            ...
                            calculator
                                .after('command-stepMoveRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getPosition(),
                                        expression.length,
                                        'The position should have been set the end'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        tokens.length - 1,
                            ...
                            calculator
                                .after('command-stepDeleteLeft.test', function () {
                                    ...
                                    assert.equal(
                                        ...
                                        expression,
                                        'The term SIN should have been removed from the expression'
                                    );
                                    assert.equal(calculator.getPosition(), 27, 'The position is now on 27');
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        16,
                                        'The current token is the next one, and the index should not have changed'
                                    );
                            ...
                            calculator
                                .after('command-stepDeleteRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getExpression(),
                                        expression,
                                        'The term SQRT should have been removed from the expression'
                                    );
                                    assert.equal(calculator.getPosition(), 27, 'The position is now on 27');
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        16,
                                        'The current token is the next one, but index should not have change'
                                    );
                            ...
                            calculator
                                .after('command-stepDeleteLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getExpression(),
                                        expression,
                                        'The term SUB should have been removed from the expression'
                                    );
                                    assert.equal(calculator.getPosition(), 25, 'The position is still on 25');
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        15,
                                        'The current token is the previous one, but the index should be the same'
                                    );
                                    assert.equal(
                                        calculator.getTokens().length,
                                        16,
                                        'Yet another token should have gone'
                                    );
                            ...
                            calculator
                                .after('command-stepDeleteRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getExpression(),
                                        expression,
                                        'The term NUM2 should have been removed from the expression'
                                    );
                                    assert.equal(
                                        calculator.getPosition(),
                                        expression.length,
                                        'The position is now at the end'
                                    );
                                    assert.equal(calculator.getTokenIndex(), 14, 'The current token is the last one');
                                    assert.equal(
                                        calculator.getTokens().length,
                                        15,
                                        'And another token should have gone'
                                    );
                            ...
                            calculator
                                .after('command-stepDeleteLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getExpression(),
                                        expression,
                                        'The term PI should have been removed from the expression'
                                    );
                                    assert.equal(
                                        calculator.getPosition(),
                                        expression.length,
                                        'The position is still at the end'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        13,
                                        'The current token is the last one, but the index should have decreased'
                                    );
                            ...
                            calculator
                                .after('command-stepDeleteRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getTokens().length,
                                        14,
                                        'No token should have been removed'
                                    );
                            ...
                            calculator
                                .after('command-stepDeleteLeft.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getExpression(),
                                        expression,
                                        'The leading space should have been removed'
                                    );
                                    assert.equal(
                                        calculator.getPosition(),
                                        0,
                                        'The position should be now the very beginning'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        0,
                            ...
                            calculator
                                .after('command-stepDeleteRight.test', function () {
                                    ...
                                    assert.equal(
                                        calculator.getExpression(),
                                        expression,
                                        'The term NUM0 should have been removed from the expression'
                                    );
                                    assert.equal(
                                        calculator.getPosition(),
                                        11,
                                        'The position is still at the offset 11'
                                    );
                                    assert.equal(
                                        calculator.getTokenIndex(),
                                        9,
                                        'The current token is at the same index, but should be the next one'
                                    );
