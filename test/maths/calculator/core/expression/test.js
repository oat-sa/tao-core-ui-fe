...
define(['ui/maths/calculator/core/expression', 'ui/maths/calculator/core/terms', 'util/mathsEvaluator'], function (
    ...
    QUnit.cases
        ...
        .test('roundLastResultVariable', function (data, assert) {
            ...
            assert.equal(
                expressionHelper.roundVariable(data.variable, data.decimalDigits),
                data.expected,
                'Should round the last result variable'
            );
        });
    ...
    QUnit.cases
        ...
        .test('roundLastResultVariable', function (data, assert) {
            ...
            assert.deepEqual(
                expressionHelper.roundLastResultVariable(data.variables, data.decimalDigits),
                data.expected,
                'Should round the last result variable'
            );
        });
    ...
    QUnit.cases
        .init([
            ...
            },
            {
                ...
                expression: '42',
                variables: {},
                expected: [renderedTokens.NUM4, renderedTokens.NUM2].join('')
            },
            {
                title: 'Simple expression',
                expression: '40+2',
                variables: {},
                expected: [renderedTokens.NUM4, renderedTokens.NUM0, renderedTokens.ADD, renderedTokens.NUM2].join('')
            },
            {
                title: 'Negative value',
                expression: '-42',
                variables: {},
                expected: [renderedTokens.NEG, renderedTokens.NUM4, renderedTokens.NUM2].join('')
            },
            {
            ...
            },
            {
                ...
                expression: '+42',
                variables: {},
                expected: [renderedTokens.POS, renderedTokens.NUM4, renderedTokens.NUM2].join('')
            },
            {
            ...
            },
            {
                ...
                expected: renderedTokens.ANS.replace(
                    '{{ans}}',
                    renderedTokens.NEG + renderedTokens.NUM4 + renderedTokens.NUM2
                )
            },
            {
                ...
                expected: renderedTokens.ANS.replace(
                    '{{ans}}',
                    renderedTokens.POS + renderedTokens.NUM4 + renderedTokens.NUM2
                )
            },
            {
            ...
            },
            {
                ...
                expression: '@nthrt',
                variables: {},
                expected: [renderedTokens.NTHRT].join('')
            },
            {
                title: 'Left exponent: 4 nthrt',
                expression: '4 @nthrt',
                variables: {},
                expected: ['<sup>', renderedTokens.NUM4, '</sup>', renderedTokens.NTHRT].join('')
            },
            {
                title: 'Left exponent: nthrt nthrt',
                expression: '@nthrt @nthrt',
                variables: {},
                expected: ['<sup>', renderedTokens.NTHRT, '</sup>', renderedTokens.NTHRT].join('')
            },
            {
                title: 'Left exponent: nthrt 16',
                expression: '@nthrt 16',
                variables: {},
                expected: [renderedTokens.NTHRT, renderedTokens.NUM1, renderedTokens.NUM6].join('')
            },
            {
            ...
            },
            {
                ...
                expression: '^',
                variables: {},
                expected: [renderedTokens.POW].join('')
            },
            {
                title: 'Right exponent: 2^',
                expression: '2^',
                variables: {},
                expected: [renderedTokens.NUM2, renderedTokens.POW].join('')
            },
            {
                title: 'Right exponent: 2^4',
                expression: '2^4',
                variables: {},
                expected: [renderedTokens.NUM2, renderedTokens.POWEL, '<sup>', renderedTokens.NUM4, '</sup>'].join('')
            },
            {
                title: 'Right exponent: 2^4^',
                expression: '2^4^',
            ...
            },
            {
                ...
                expression: '2^PI',
                variables: {},
                expected: [renderedTokens.NUM2, renderedTokens.POWEL, '<sup>', renderedTokens.PI, '</sup>'].join('')
            },
            {
                title: 'Right exponent: (2^PI)',
                expression: '(2^PI)',
        ...
        .test('render', function (data, assert) {
            ...
            assert.equal(
                expressionHelper.render(data.expression, data.variables),
                data.expected,
                'Should render the tokens properly'
            );
        });
});
