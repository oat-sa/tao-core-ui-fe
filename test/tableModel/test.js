...
define(['lodash', 'jquery', 'ui/tableModel'], function(_, $, tableModelFactory) {
    ...
    QUnit.cases
        .init([{ title: 'no table' }, { title: 'not a table', table: $('<div>') }])
        .test('Factory constructor with incorrect table reference', function(data, assert) {
            ...
            assert.throws(
                ...
                TypeError,
                'factory throws an exception if given an incorrect parameter'
            );
        });
