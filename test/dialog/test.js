...
define(['jquery', 'lodash', 'ui/dialog'], function($, _, dialog) {
    ...
    QUnit.test('install', function(assert) {
        ...
        assert.equal(
            modal
                ...
                .text(),
            content,
            'The dialog box displays an additional content'
        );
    ...
    QUnit.test('buttons', function(assert) {
        ...
        modal
            .getDom()
            .find('button[data-control="yes"]')
            .click();
        modal
            .getDom()
            .find('button[data-control="no"]')
            .click();
        modal
            .getDom()
        ...
        modal
            .getDom()
            .find('button[data-control="cancel"]')
            .click();
