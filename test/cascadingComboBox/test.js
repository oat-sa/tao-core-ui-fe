...
define(['jquery', 'lodash', 'ui/cascadingComboBox', 'css!taoCss/tao-3.css', 'css!taoCss/tao-main-style.css'], function(
    ...
    QUnit.test('render (all options)', function(assert) {
        ...
        $container.off('selected.cascading-combobox').on('selected.cascading-combobox', function(x, val) {
