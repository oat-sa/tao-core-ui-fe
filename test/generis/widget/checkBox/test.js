    ...
    QUnit.test('DOM', function (assert) {
        ...
        generisWidgetCheckBoxFactory(
            ...
            .on('render', function () {
                ...
                assert.deepEqual(
                    $('.check-box', $container)[0],
                    $element[0],
                    'The rendered element is the component element'
                );
                ...
                assert.equal(
                    $('.option:nth-child(1) input', $element).val(),
                    'http://foo#v1',
                    '1st option value is correct'
                );
                ...
                assert.equal(
                    $('.option:nth-child(2) input', $element).val(),
                    'http://foo#v2',
                    '2nd option value is correct'
                );
                ready();
            })
            .render($container);
