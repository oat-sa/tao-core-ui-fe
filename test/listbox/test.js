...
define(['jquery', 'lodash', 'ui/listbox'], function($, _, listBox) {
    ...
    QUnit.test('init', function(assert) {
        ...
        assert.equal(
            ...
            config.textNumber,
            'The listBox instance must catch the textNumber config'
        );
        assert.equal(
    ...
    QUnit.test('render', function(assert) {
        ...
        assert.equal(
            ...
            'object',
            'The listBox instance returns the rendered content as an object'
        );
        ...
        assert.equal(
            instance.getElement().find('.list .entry').length,
            config.list.length,
    ...
    QUnit.test('update', function(assert) {
        ...
        assert.equal(
            instance.getElement().find('.list .entry').length,
            0,
            'The listBox instance has rendered an empty list'
        );
        assert.equal(
            instance.getElement().hasClass('empty'),
            true,
            'The listBox instance displays a message telling the list is empty'
        );
        assert.equal(
            instance.getElement().hasClass('loaded'),
            false,
            'The listBox instance does not display the number of boxes'
        );
        ...
        assert.equal(
            instance.getElement().hasClass('empty'),
            false,
            'The listBox instance does not display a message telling the list is empty'
        );
        assert.equal(
            instance.getElement().hasClass('loaded'),
            true,
            'The listBox instance displays the number of boxes'
        );
        assert.equal(instance.getElement().hasClass('loading'), false, 'The listBox instance is not loading');
        assert.equal(
            instance
    ...
    QUnit.test('show/hide', function(assert) {
        ...
        assert.equal(
            ...
            false,
            'The listBox instance does not have the hidden class'
        );
    ...
    QUnit.test('enable/disable', function(assert) {
        ...
        assert.equal(
            ...
            false,
            'The listBox instance does not have the disabled class'
        );
    ...
    QUnit.test('state', function(assert) {
        ...
        assert.equal(
            instance.getElement().hasClass('loading'),
            false,
            'The listBox instance does not have the loading class'
        );
        ...
        assert.equal(
            ...
            false,
            'The listBox instance does not have the customState class'
        );
        ...
        assert.equal(
            instance.getElement().hasClass('customState'),
            true,
            'The listBox instance has the customState class'
        );
