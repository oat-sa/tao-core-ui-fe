 ...
 */
define(['jquery', 'lodash', 'ui/areaBroker', 'ui/component'], function($, _, areaBroker, componentFactory) {
    'use strict';
    ...
    QUnit.test('factory', function(assert) {
        ...
        assert.notEqual(
            areaBroker(required, $container, mapping),
            areaBroker(required, $container, mapping),
    ...
    QUnit.test('define mapping', function(assert) {
        ...
        assert.throws(
            ...
            Error,
            'trying to get an area without a mapping defined throws an error'
        );
    });
    ...
    QUnit.test('setComponent incorrect use', function(assert) {
        ...
        assert.throws(
            ...
            TypeError,
            'setComponent requires a valid area name'
        );
        ...
        assert.throws(
            ...
            TypeError,
            'setComponent requires a valid component'
        );
