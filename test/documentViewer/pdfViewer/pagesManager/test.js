                ...
                return pdf.getPage(1).then(function(page) {
                    return instance.renderPage(page).then(function() {
                        assert.equal(
                            ...
                            textManager1,
                            'The view uses the right text manager'
                        );
                        ...
                        assert.equal(
                            instance.getTextManager(),
                            textManager2,
                            'The getTextManager() method returns the right object'
                        );

                        assert.notEqual(
                            instance.getActiveView().getTextManager(),
                            textManager1,
                            'The text manager has been changed into the view'
                        );
                        assert.equal(
                            instance.getActiveView().getTextManager(),
                            textManager2,
