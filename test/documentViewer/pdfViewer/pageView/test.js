...
define([
    ...
    QUnit.cases.init(pageViewApi).test('instance API ', function (data, assert) {
        var $container = $('#qunit-fixture');
        var config = {
            pageNum: 1
        };
    ...
    QUnit.test('attributes', function (assert) {
        ...
        assert.equal(
            instance.pageNum,
            config.pageNum,
            'The pdfViewer PageView instance contains the right page number'
        );
    ...
    QUnit.test('getDrawLayerElement', function (assert) {
        ...
        assert.equal(
            typeof instance.getDrawLayerElement(),
            'object',
            'The getDrawLayerElement() method returns an object'
        );
        ...
        assert.ok(
            instance.getDrawLayerElement().parent().is(instance.getElement()),
            'The draw layer is contained by the page container'
        );
    ...
    QUnit.test('getTextLayerElement', function (assert) {
        ...
        assert.equal(
            typeof instance.getTextLayerElement(),
            'object',
            'The getTextLayerElement() method returns an object'
        );
        ...
        assert.ok(
            instance.getTextLayerElement().parent().is(instance.getElement()),
            'The text layer is contained by the page container'
        );
    ...
    QUnit.test('getCanvas', function (assert) {
        ...
        assert.ok(
            $(instance.getCanvas()).parent().is(instance.getElement()),
            'The canvas is contained by the page container'
        );
    ...
    QUnit.test('getRenderingContext', function (assert) {
        ...
        assert.equal(
            typeof instance.getRenderingContext(),
            'object',
            'The getRenderingContext() method returns an object'
        );
        assert.equal(
            instance.getRenderingContext(),
            instance.getCanvas().getContext('2d'),
            'This is the canvas rendering context'
        );
    ...
    QUnit.cases.init(pageRenderSets).test('render ', function (data, assert) {
        var $container = $('#qunit-fixture');
        var config = {
            pageNum: 1
        };
    ...
    QUnit.cases.init(pageRenderSets).test('render with text layer ', function (data, assert) {
        var ready = assert.async();
        var $container = $('#qunit-fixture');
            ...
            .then(function (pdf) {
                ...
                return pdf.getPage(1).then(function (page) {
                    return instance.render(page, data.fitToWidth).then(function () {
                        ...
                        assert.notEqual(
                            instance.getTextLayerElement().children().length,
                            0,
                            'The text layer contains text'
                        );
                        assert.equal(
                            instance.getTextLayerElement().text(),
                            expectedFullText,
                            'The text layer contains the right text'
                        );
