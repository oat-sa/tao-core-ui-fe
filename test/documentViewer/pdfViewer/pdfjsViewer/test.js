    ...
    QUnit.test('render', function(assert) {
        ...
        promise
            .then(function() {
                ...
                assert.equal(
                    $container.find('.pdf-container').length,
                    0,
                    'The viewer has been removed from the container'
                );
                assert.equal($container.children().length, 0, 'The container does not contain any children');
        ...
        instance
            ...
            .then(function() {
                ...
                return instance.load(pdfUrl).then(function() {
                    ...
                    assert.equal(
                        $container.find('[data-control="pdf-search"]').length,
                        1,
                        'The search button has been added'
                    );
