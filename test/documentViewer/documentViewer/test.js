...
define(['lodash', 'core/promise', 'ui/documentViewer'], function(_, Promise, documentViewer) {
    ...
    QUnit.test('module', function(assert) {
        ...
        assert.notStrictEqual(
            documentViewer(),
            documentViewer(),
            'The documentViewer factory provides a different object on each call'
        );
        assert.equal(
            typeof documentViewer.registerProvider,
            'function',
            'The instance module exposes a function registerProvider()'
        );
        assert.equal(
            typeof documentViewer.clearProviders,
            'function',
            'The instance module exposes a function clearProviders()'
        );
    });
