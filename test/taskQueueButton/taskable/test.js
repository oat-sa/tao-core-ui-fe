    ...
    QUnit.test('enqueued', function(assert) {
        ...
        var taskQueue = taskQueueModelFactory({
            url: {
                ...
                get: '/test/taskQueueButton/taskable/samples/getOne.json'
            }
        }).on('error', function() {
        ...
        var taskableConfig = {
            taskQueue: taskQueue,
            taskCreationUrl: '/test/taskQueueButton/taskable/samples/newTaskCreationResult.json',
    ...
    QUnit.test('finished', function(assert) {
        ...
        var taskQueue = taskQueueModelFactory({
            ...
            .on('pollSingle', function() {
                ...
                this.setEndpoints({
                    get: '/test/taskQueueButton/taskable/samples/getOne-completed.json'
                });
            })
            .on('error', function() {
                assert.ok(false, 'should not have any error');
