...
define(['jquery', 'lodash', 'ui/breadcrumbs'], function ($, _, breadcrumbs) {
    ...
    QUnit.test('module', function (assert) {
        ...
        assert.notStrictEqual(
            breadcrumbs(),
            breadcrumbs(),
            'The breadcrumbs factory provides a different object on each call'
        );
    });
    ...
    QUnit.test('render', function (assert) {
        ...
        assert.equal(
            ...
            'object',
            'The breadcrumbs instance returns the rendered content as an object'
        );
        ...
        assert.equal(
            instance.getElement().find('> li').length,
            breadcrumbsEntries.length,
            'The breadcrumbs instance has rendered the list of entries'
        );
    ...
    QUnit.test('update', function (assert) {
        ...
        assert.equal(
            instance.getElement().find('> li').length,
            breadcrumbsEntries.length,
            '[1st pass] The breadcrumbs instance has rendered the list of entries'
        );
        ...
        assert.equal(
            instance.getElement().find('> li').length,
            breadcrumbsEntries2.length,
            '[2nd pass] The breadcrumbs instance has rendered the list of entries'
        );
        ...
        assert.equal(
            typeof instance.getElement(),
            'object',
            '[3rd pass] The breadcrumbs instance returns the rendered content as an object'
        );
        assert.equal(
            instance.getElement().length,
            1,
        ...
        assert.equal(
            ...
            '[3rd pass] The breadcrumbs instance is rendered inside the right container and is the only child'
        );

        assert.equal(
            instance.getElement().find('> li').length,
            breadcrumbsEntries.length,
            '[3rd pass] The breadcrumbs instance has rendered the list of entries'
        );
        ...
        assert.equal(
            typeof instance.getElement(),
            'object',
            '[4th pass] The breadcrumbs instance returns the rendered content as an object'
        );
        assert.equal(
            instance.getElement().length,
            1,
        ...
        assert.equal(
            instance.getElement().find('> li').length,
            breadcrumbsEntries2.length,
            '[4th pass] The breadcrumbs instance has rendered the list of entries'
        );
        ...
        assert.equal(
            instance.getElement(),
            null,
            '[4th pass] The breadcrumbs instance has removed its rendered content'
        );
    });
    ...
    QUnit.test('show/hide', function (assert) {
        ...
        assert.equal(
            ...
            false,
            'The breadcrumbs instance does not have the hidden class'
        );
    ...
    QUnit.test('enable/disable', function (assert) {
        ...
        assert.equal(
            ...
            false,
            'The breadcrumbs instance does not have the disabled class'
        );
        ...
        assert.equal(
            instance.getElement().hasClass('disabled'),
            true,
            'The breadcrumbs instance has the disabled class'
        );
    ...
    QUnit.test('state', function (assert) {
        ...
        assert.equal(
            ...
            false,
            'The breadcrumbs instance does not have the customState class'
        );
        ...
        assert.equal(
            instance.getElement().hasClass('customState'),
            true,
            'The breadcrumbs instance has the customState class'
        );
