...
define(['jquery', 'ui/autocomplete', 'lib/simulator/jquery.keystroker'], function ($, autocompleteUI, keystroker) {
    ...
    QUnit.test('ui/autocomplete module', function (assert) {
        ...
        assert.ok(
            ...
            'The ui/autocomplete factory provides a different object on each call'
        );
    });
    ...
    QUnit.cases.init(autocompleteApi).test('ui/autocomplete instance API ', function (data, assert) {
    ...
    QUnit.test('ui/autocomplete getter/setter', function (assert) {
        ...
        assert.equal(
            instance.getValue(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "value"'
        );
        ...
        assert.equal(
            instance.getLabel(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "label"'
        );

        expected = 'http://www.tao.lu/Ontologies/TAO.rdf#User';
        instance.setOntology(expected);
        assert.equal(
            instance.getOntology(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "ontology"'
        );

        expected = 'value1234';
        instance.setValueField(expected);
        assert.equal(
            instance.getValueField(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "valueField"'
        );
        ...
        assert.equal(
            ...
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "labelField"'
        );

        expected = true;
        instance.setIsProvider(expected);
        assert.equal(
            instance.getIsProvider(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "isProvider"'
        );
        expected = false;
        instance.setIsProvider(expected);
        assert.equal(
        ...
        assert.equal(
            instance.getQueryParam(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "queryParam"'
        );

        expected = 'ontology';
        instance.setOntologyParam(expected);
        assert.equal(
            instance.getOntologyParam(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "ontologyParam"'
        );

        expected = 'params';
        instance.setParamsRoot(expected);
        assert.equal(
            instance.getParamsRoot(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "paramsRoot"'
        );
        assert.equal(
            instance.getQueryParam(),
            'params[fragment]',
            'The ui/autocomplete instance must provide adjusted value for "queryParam" when "paramsRoot" is defined'
        );
        assert.equal(
            instance.getOntologyParam(),
            'params[ontology]',
            'The ui/autocomplete instance must provide adjusted value for "ontologyParam" when "paramsRoot" is defined'
        );
        ...
        assert.equal(
            instance.getUrl(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "url"'
        );
        ...
        assert.equal(
            instance.getType(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "type"'
        );
        ...
        assert.equal(
            instance.getType(),
            expected,
            'The ui/autocomplete instance must provide default value for "type"'
        );
        ...
        assert.equal(
            instance.getDelay(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "delay"'
        );
        ...
        assert.equal(
            instance.getDelay(),
            expected,
            'The ui/autocomplete instance must provide default value for "delay"'
        );
        instance.setDelay(-1);
        assert.equal(
            instance.getDelay(),
        ...
        assert.equal(
            instance.getMinChars(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "minChars"'
        );
        ...
        assert.equal(
            instance.getMinChars(),
            expected,
            'The ui/autocomplete instance must provide default value for "minChars"'
        );
        ...
        assert.deepEqual(
            instance.getParams(),
            expected,
            'The ui/autocomplete instance must provide nested "params" when "paramsRoot" is defined'
        );
        ...
        assert.deepEqual(
            instance.getParams(),
            expected,
            'The ui/autocomplete instance must provide "params" when "paramsRoot" is not defined'
        );
        ...
        assert.deepEqual(
            instance.getParams(),
            expected,
            'The ui/autocomplete instance must provide bidirectional access to "params"'
        );
    });

    QUnit.test('ui/autocomplete load options from DOM', function (assert) {
        var expectedUrl = '/test/autocomplete/test.success.json';
        ...
        assert.equal(
            instance.getUrl(),
            expectedUrl,
            'The ui/autocomplete instance must provide the value loaded from the DOM for the property "url"'
        );
        assert.equal(
            instance.getOntology(),
            expectedOntology,
            'The ui/autocomplete instance must provide the value loaded from the DOM for the property "ontology"'
        );
        assert.equal(
            instance.getParamsRoot(),
            expectedParamsRoot,
            'The ui/autocomplete instance must provide the value loaded from the DOM for the property "paramsRoot"'
        );
    });
    ...
    QUnit.test('ui/autocomplete successful query', function (assert) {
        ...
        let element;
        let stopper;
        const instance = autocompleteUI('#autocomplete2', {
            url: '/test/autocomplete/test.success.json',
            ...
            onSearchStart: function () {
                ...
                assert.ok(
                    true,
                    'The ui/autocomplete instance must fire the searchSearch event when the user inputs a query'
                );
            ...
            onSearchComplete: function () {
                ...
                assert.ok(
                    true,
                    'The ui/autocomplete instance must fire the searchComplete event after server response'
                );
            ...
            onSelectItem: function () {
                ...
                assert.equal(
                    element.val(),
                    'user',
                    'The ui/autocomplete instance keep the value of the selected item in the textbox'
                );
                assert.equal(
                    instance.getValue(),
                    'http://tao.dev/tao-dev.rdf#i1431522022337107',
                    'The ui/autocomplete instance must keep the value of the selected item'
                );
                assert.equal(
                    instance.getLabel(),
                    'user',
                    'The ui/autocomplete instance must keep the label of the selected item'
                );
    ...
    QUnit.test('ui/autocomplete failed query', function (assert) {
        ...
        let stopper;
        let element;
        const instance = autocompleteUI('#autocomplete3', {
            url: '/test/autocomplete/test.blank.json',
            ...
            onSearchComplete: function () {
                ...
                stopper = setTimeout(function () {
                    assert.ok(
                        true,
                        'The ui/autocomplete instance must not fire the selectItem event when no item is selectable'
                    );
                    ready();
                }, 500);
        ...
        var instance = autocompleteUI('#autocomplete4', {
            ...
            onSelectItem: function () {
                ...
                assert.equal(
                    element.val(),
                    '',
                    'The ui/autocomplete instance must clear the value of the selected item in the textbox'
                );
                assert.equal(
                    instance.getValue(),
                    'http://tao.dev/tao-dev.rdf#i1431522022337107',
